...
class UnitTests(unittest.TestCase):
    ...
    def test_yaml_download(self):
        bible_yaml_downloader.yaml_download_book('Philemon', file_location='./tmp/test_yaml_download/')
    ...
    def test_yaml_download_invalid_book(self):
        bible_yaml_downloader.yaml_download_book('Barnabas', file_location='./tmp/test_yaml_download_invalid_book/')
    ...
    def test_yaml_download_nlt(self):
        bible_yaml_downloader.yaml_download_book('Philemon', file_location='./tmp/test_yaml_download_nlt/',
                                                 translation='NLT')
    ...
    def test_yaml_download_omitted_passage(self):
        bible_yaml_downloader.yaml_download_book('Romans', file_location='./tmp/test_yaml_download_omitted_passage/',
                                                 translation='NLT')
